...
// Imports spécifiques Three.js pour tree-shaking
import { 
  Scene, 
  PerspectiveCamera, 
  WebGLRenderer, 
...
export default function ThreeScene() {
  ...
  useEffect(() => {
    ...
    const materials = [
      new MeshPhongMaterial({ color: 0x4f46e5, shininess: 50 }), // Indigo
      new MeshPhongMaterial({ color: 0x7c3aed, shininess: 50 }), // Violet
      new MeshPhongMaterial({ color: 0xec4899, shininess: 50 })  // Pink
    ]
